...
public class FoodMenuItemAdapter extends ArrayAdapter<FoodMenuItem> {
	...
	public FoodMenuItemAdapter(Context context,
			ArrayList<FoodMenuItem> foodMenuItems, numListener numCallBack) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		LayoutInflater l_Inflater = (LayoutInflater) getContext()
		...
		if (convertView == null) {
			...
			holder.addItem = (Button) convertView
					.findViewById(R.id.addbutton);
			holder.addItem.setTag(foodItem);
			holder.subItem = (ImageButton) convertView
					.findViewById(R.id.subbutton);
	...
	public void onQtyChange(FoodMenuItem foodMenuItem, int quantity) {
		numCallBack.onQtyChange(foodMenuItem, quantity);
		// Toast.makeText(this,
		// orderItems.toString(),Toast.LENGTH_SHORT).show();
	}
